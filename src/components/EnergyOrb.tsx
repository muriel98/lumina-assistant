...
interface EnergyOrbProps {
  scale?: number; // 1 = full size, 0.25 = small
}
...
export function EnergyOrb({ scale = 1 }: EnergyOrbProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {waves.map((delay, i) => (
          <div
            ...
            style={{
              ...
              top: "50%",
              left: "50%",
              marginTop: -(ORB_SIZE * 1.2) / 2,
              marginLeft: -(ORB_SIZE * 1.2) / 2,
        ...
        {/* The core */}
        <div
          className="absolute rounded-full bg-gradient-orb shadow-orb animate-heartbeat transition-transform duration-1000 ease-in-out"
          style={{
            width: ORB_SIZE,
            height: ORB_SIZE,
            top: "50%",
